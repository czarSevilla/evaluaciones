...
CREATE TABLE `ev_configurations` (
  ...
  `config_desc` varchar(400) DEFAULT NULL,
...
INSERT INTO `ev_configurations` VALUES (1,'EXPIRATION_DAY','5','Número de días que está vigenete una evaluación para poderla ejecutar.'),(2,'URL_SITE','http://192.168.0.92:8080/evaluaciones','Dirección web de la aplicación que será incluida en las notificaciones por correo electrónico.'),(3,'EXAM_MINUTES','120','Número de minutos que tiene un Aplicante para ejecutar una evaluación.'),(4,'QUESTIONS_X_PAGE','10','Número de preguntas que tendrá una evaluación por página.'),(5,'ROWS_X_PAGE','20','Número de registros que serán presentados por página en los diferentes módulos.'),(6,'MAX_TAG_SIZE','5','Tamaño máximo de la litra utilizado en el cloud de categorías en el módulo de evaluaciones.'),(7,'PASS_VALUE','70','Calificación mínima que deberá obtener un Aplicante para aprobar una evaluación siendo 100 el máximo a obtener.');
...
INSERT INTO `ev_questions_categories` VALUES (1,1,1),(2,2,1),(3,3,1),(10,4,1),(11,5,17),(7,6,1),(12,7,19),(18,8,19),(19,8,21),(16,8,22),(17,8,23),(21,9,24),(22,10,24);
...
-- Dump completed on 2017-08-02 19:37:09
